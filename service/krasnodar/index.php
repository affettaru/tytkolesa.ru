...
$APPLICATION->SetTitle("Шиномонтаж в Краснодаре");
?>
<section>
            <div class="container">
                    ...
                    <div class="pagehead">
                        ...
                        <div class="pagehead__body">
                            <div class="pagehead__content">
                                <div class="h1">Шиномонтаж в Краснодаре </div>
                            ...
                            <div class="pagehead__footer">
                                <div class="row">
									...
									<?if(!CModule::IncludeModule("iblock"))
										return; 
										$res = CIBlockElement::GetList(array("SORT"=>"ASC"),array('IBLOCK_ID' => 9, 'ID'=>331), false, false, array("PROPERTY_PRICE_FILE"));
										while ($row = $res->Fetch())
										{
											$url=CFile::GetPath($row["PROPERTY_PRICE_FILE_VALUE"]);
										}
											if($url){?>
                                    <div class="col-12 col-md-auto"><a class="mbtn mbtn__grey2 mbtn__big d-block w-100" href="<?=$url?>" download="krasnodar-price">Скачать прайс-лист</a></div><?}?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block__padd">
					...
					<?php
                    $GLOBALS['arrFilter'] = array('ID' => 331);
