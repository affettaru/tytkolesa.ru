...
<?
	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		...
		<div class="row">
            ...
            <div class="cart__list cart__basket1" id="basket-items-list-wrapper">
                <div class="cart__list__item cart__list__head d-none d-md-flex">
					<div class="cart__list__card">
						<div class="cart__list__hlabel">Название</div>
					</div>
					<div class="cart__list__des">
						<div class="cart__list__prices">
							<div class="cart__list__hlabel">Цена</div>
						</div>
						<div class="cart__list__counter">
							<div class="cart__list__hlabel text-center">Количество</div>
						</div>
						<div class="cart__list__pricesumm">
							<div class="cart__list__hlabel">Сумма</div>
						</div>
					</div>
				</div>

					<!-- <div class="cart__list__item" id="basket-items-list-container">
						<div class="basket-items-list-overlay" id="basket-items-list-overlay" style="display: none;"></div>
						<div class="" id="basket-item-table">
										 -->
