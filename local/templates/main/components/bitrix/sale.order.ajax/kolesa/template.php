	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" class="bx-soa-wrapper mb-4<?=$themeClass?>" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row" style="opacity: 0">
			...
			<div class="col-lg-8 col-md-7 bx-soa">
				<div id="bx-soa-main-notifications" class="none">
				...
				?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" style="display: none;" class="none bx-soa-section bx-active">
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" data-visited="false" class="none bx-soa-section bx-active">
					<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
						<div class="bx-soa-section-title" data-entity="section-title">
				...
				?>
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" style="display:none" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
					...
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" style="display:none" class="none bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
				...
				?>
					...
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="none bx-soa-section bx-active">
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
								<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?>
							</div>
				...
				?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" style="display:none" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
							<div class="bx-soa-section-title" data-entity="section-title">
