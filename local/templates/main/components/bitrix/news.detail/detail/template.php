                    ...
                    <div class="article__footer">
                        <div class="article__share">
                            ...
                            <div class="article__share__body">
                                <ul>
                                    <li><a  id="copy_link" class="bg__green" value="<?=$arResult["DETAIL_PAGE_URL"]?>" target="_blank" rel="noopener noreferrer"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
