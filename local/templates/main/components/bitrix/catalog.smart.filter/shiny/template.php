...
<div class="col-12 col-lg-6">
	<!-- <div class="smart-filter-section"> -->
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="/catalog/shiny/" method="get" class="">

			<div class="filter__btnslide d-lg-none js--filter-title">
				<div class="filter__btnslide__img">
					<img src="<?=SITE_TEMPLATE_PATH?>/img/filter/bg-filter-1-title.png" alt="">
				</div>
			...
			<div class="filter js--filter-slider">
				...
				<div class="filter__content">
					<div class="filter__img">
						<img src="/local/templates/main/img/filter/bg-filter-1.png" alt="">
					</div>
			...
			<div class="filter__line1 row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					?>
<?if($arItem["NAME"]=="Ширина (W)" || $arItem["NAME"]=="Профиль (H)" || $arItem["NAME"]=="Диаметр (D)" || $arItem["NAME"]=="Производитель"){?>
    ...
    z-index: 5;">
				...
				<div class="filter__line2 filter__mt row">
				<div class="col-12 col-sm-6 col-md-8 col-lg-6 col-xxl-8">
				<div class="filter__line2 row">
				<!-- <?/*if($arItem["NAME"]=="Сезонность" || $arItem["NAME"]=="Шипы"){*/?> -->
	<!-- || $arItem["CODE"]=="U_REINFORCED" || $arItem["CODE"]=="U_RUNFLAT" -->
	...
	<!-- || $arItem["CODE"]=="U_REINFORCED" || $arItem["CODE"]=="U_RUNFLAT" -->
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					?>
							...
							<!-- || $arItem["CODE"]=="U_REINFORCED" || $arItem["CODE"]=="U_RUNFLAT" -->
							<!-- <div class="col-12 col-sm-6 col-md-8 col-lg-6 col-xxl-8"> -->
						<?if($arItem["CODE"]=="U_REINFORCED" || $arItem["CODE"]=="U_RUNFLAT"){?>				
