<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true)
	die(); ?>
<div class="remodal" data-remodal-id="cl1">
    <button data-remodal-action="close" class="remodal-close"></button>

    <div class="remodal__in">
        <div class="remodal__top">
            <div class="remodal__title">Получить КП</div>
        </div>
                ...
                <form id="<?= $arParams["TOKEN"] ?>">
                    ...
                    <div class="frm__soc">
                        ...
                        <div class="frm__check">
                            <input type="checkbox" id="checkSoc11"  name="SOC[]" value="Telegram">
                            <label for="checkSoc11">Telegram</label>
                        </div>
                        <div class="frm__check">
                            <input type="checkbox" id="checkSoc21" checked  name="SOC[]" value="WhatsApp">
                            <label for="checkSoc21">WhatsApp</label>
                        </div>
                        <div class="frm__check">
                    ...
                    <div class="frm__ch">
                        <div class="frm__check">
                            ...
                            <label for="check11"><span><span>Согласен с <a href="/policy/">политикой конфиденциальности</a> </span> </span></label>
                        </div>
                    </div>
