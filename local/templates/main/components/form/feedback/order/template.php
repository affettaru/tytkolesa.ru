<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true)
    ...
    <div class="modal" id="js--modal-record">
        <div class="modal__content">
            <div class="h1 text-center">Записаться на шиномонтаж</div>
            <form class="form form__light" id="<?= $arParams["TOKEN"] ?>">
                <div class="form__line row">
                    ...
                    <div class="col-12"><select class="js--select" name="CITY">
                            <option value="Краснодар">Краснодар</option>
                            <option value="Железногорск">Железногорск</option>
                        </select></div>
                    <div class="col-12"><input class="form__input js--inputmask" type="tel" placeholder="Телефон*" name="PHONE"/></div>
                    <div class="col-12"><input class="form__input" type="text" placeholder="Марка, модель и год выпуска вашего авто" name="MESSAGE"/></div>
                    <div class="col-12"><input class="form__input" type="text" placeholder="Диаметр диска"  name="TEXT"/></div>
                    ...
                    <input type="text" hidden="" value="Записаться на шиномонтаж" name="TITLE">
                </div>
            </form>
        </div>
    </div>
