...
<form id="<?= $arParams["TOKEN"] ?>">
    <div class="frm__in">
        ...
        <div class="frm__cell">
            <input type="text" placeholder="Ваш телефон*" name="PHONE" id="PHONE_RENT">
        </div>
        <div class="frm__cell">
    ...
    <div class="frm__soc">
        ...
        <div class="frm__check">
            <input type="checkbox" id="checkSoc1" name="SOC[]" value="Telegram">
            <label for="checkSoc1">Telegram</label>
        </div>

        <div class="frm__check">
            <input type="checkbox" id="checkSoc2"  name="SOC[]" value="WhatsApp">
            <label for="checkSoc2">WhatsApp</label>
        </div>
        <div class="frm__check">
    ...
    <div class="frm__ch">
        <div class="frm__check">
            ...
            <label for="check1"><span>Согласен с <a href="/policy/">политикой конфиденциальности</a> </span> </label>
        </div>
    </div>
    <input hidden="" name="TYPE" value="Продажа">
