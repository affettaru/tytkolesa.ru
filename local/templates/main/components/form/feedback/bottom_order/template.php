...
<form class="form" id="<?= $arParams["TOKEN"] ?>">
    <div class="form__columns">
        ...
        <div class="form__item form__item__sizehalf"><input class="form__input js--maskphone" id="PHONE_<?= $arParams["TOKEN"] ?>" type="tel" name="PHONE" /></div>
        ...
        <div class="form__item"><button id="btn_<?= $arParams["TOKEN"] ?>" class="mbtn mbtn__primary mbtn__block" type="submit">Записаться к врачу</button>
